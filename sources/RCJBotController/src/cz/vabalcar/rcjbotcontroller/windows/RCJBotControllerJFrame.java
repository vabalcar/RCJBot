...
import cz.vabalcar.rcjbotcontroller.VisualizingSensorDataListener;
import cz.vabalcar.jbot.RemoteJBot;
import cz.vabalcar.util.FloatArray;
import cz.vabalcar.rcjbotcontroller.SensorDataVisualizer;
...
public class RCJBotControllerJFrame extends JFrame {
    ...
    public RCJBotControllerJFrame() {
        ...
        SensorDataVisualizer sensorDataVisualizer = new SensorDataVisualizer();
        sensorDataVisualizer.setBounds(441, 0, 405, 582);
        ...
        jBot.addListener(new VisualizingSensorDataListener(sensorDataVisualizer));
    }
